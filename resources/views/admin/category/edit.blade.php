...
@section('content')
 ...
 <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
               <form action='{{route('admin.categoryUpdate',encrypt($category->id))}}' method='post', enctype='multipart/form-data'>
              @csrf
              <div class="card">
                        <div class="card-body">
                          <span style="float:right">  <a href="{{route('admin.category.index')}}"> View All Job Id</a></span>
                            ...
                            <div class="row">
                                     <div class="col-md-12">
                                      ...
                                      <input type="text" name="name" placeholder="Enter Job Id" value="{{$category->name}}" class="form-control @error('name') is-invalid @enderror" >
